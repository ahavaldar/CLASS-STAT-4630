...
table(y.test, tree.pred.test) ##actual classes in rows, predicted classes in columns

##overall accuracy
mean(tree.pred.test==y.test) ##0.838
...
##overall accuracy
mean(tree.pred.prune==y.test) ##0.849. small improvement over recursive binary splitting
